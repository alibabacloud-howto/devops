...
var Header = __webpack_require__(/*! ./components/Header */ "./src/main/js/components/Header.js");

var TaskList = __webpack_require__(/*! ./components/TaskList */ "./src/main/js/components/TaskList.js");

function App() {
  return React.createElement("div", {
    id: "app"
  }, React.createElement(Header, null), React.createElement(TaskList, null));
}
...
/***/ "./src/main/js/components/Header.js":
/*!******************************************!*\
  !*** ./src/main/js/components/Header.js ***!
  \******************************************/
/*! no static exports found */
...
var machineService = __webpack_require__(/*! ../services/machineService */ "./src/main/js/services/machineService.js");
...
function (_React$Component) {
  ...
  _createClass(Header, [{
    ...
    value: function componentDidMount() {
      ...
      machineService.find().then(function (machine) {
        _this2.setState({
          machine: machine
        });
    ...
    value: function render() {
      return React.createElement("header", null, React.createElement("div", {
        ...
        id: "header-context"
      }, React.createElement("div", null, "Hostname: ", this.state.machine.hostname), React.createElement("div", null, "Instance Id: ", this.state.machine.instanceId)));
    }
  }]);
...
/***/ "./src/main/js/components/TaskForm.js":
/*!********************************************!*\
  !*** ./src/main/js/components/TaskForm.js ***!
  \********************************************/
/*! no static exports found */
...
var Task = __webpack_require__(/*! ../model/Task */ "./src/main/js/model/Task.js");

var uuidUtils = __webpack_require__(/*! ../utils/uuidUtils */ "./src/main/js/utils/uuidUtils.js");
...
/***/ "./src/main/js/components/TaskList.js":
/*!********************************************!*\
  !*** ./src/main/js/components/TaskList.js ***!
  \********************************************/
/*! no static exports found */
...
var TaskListItem = __webpack_require__(/*! ./TaskListItem */ "./src/main/js/components/TaskListItem.js");

var TaskForm = __webpack_require__(/*! ./TaskForm */ "./src/main/js/components/TaskForm.js");

var taskService = __webpack_require__(/*! ../services/taskService */ "./src/main/js/services/taskService.js");
...
function (_React$Component) {
  ...
  _createClass(TaskList, [{
    ...
    value: function componentDidMount() {
      ...
      taskService.findAll().then(function (tasks) {
        _this2.setState({
          tasks: tasks
        });
      }).catch(function (error) {
        console.error("Unable to find all the tasks: ".concat(JSON.stringify(error)));
      });
    }
    /**
    ...
    key: "deleteTask",
    value: function deleteTask(taskUuid) {
      var _this3 = this;

      taskService.deleteByUuid(taskUuid).then(function (task) {
        var newTasks = _this3.state.tasks.filter(function (t) {
        ...
        console.error("Unable to delete the task ".concat(taskUuid, ": ").concat(JSON.stringify(error)));
      });
    }
    /**
     * @param {Task} task
    ...
    value: function createTask(task) {
      ...
      taskService.create(task).then(function (task) {
        var newTasks = _this4.state.tasks.concat([task]);

        _this4.setState({
          tasks: newTasks
        });
      }).catch(function (error) {
        console.error("Unable to create the task ".concat(JSON.stringify(task), ": ").concat(JSON.stringify(error)));
      });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var items = this.state.tasks.map(function (task) {
        return React.createElement(TaskListItem, {
          key: task.uuid,
          description: task.description,
          onClick: function onClick() {
            return _this5.deleteTask(task.uuid);
          }
        });
      });
      return React.createElement("div", {
        id: "task-list"
      }, React.createElement("h1", null, "Tasks"), React.createElement("h2", null, "Add a new task"), React.createElement(TaskForm, {
        onSubmit: function onSubmit(task) {
          return _this5.createTask(task);
        }
      }), React.createElement("h2", null, "Existing tasks"), React.createElement("table", null, React.createElement("tbody", null, React.createElement("tr", null, React.createElement("th", null, "Description"), React.createElement("th", {
...
/***/ "./src/main/js/components/TaskListItem.js":
/*!************************************************!*\
  !*** ./src/main/js/components/TaskListItem.js ***!
  \************************************************/
/*! no static exports found */
...
function (_React$Component) {
  ...
  _createClass(TaskListItem, [{
    key: "render",
    value: function render() {
      return React.createElement("tr", null, React.createElement("td", null, this.props.description), React.createElement("td", {
        className: "task-list-actions"
      }, React.createElement("button", {
 ...
 * limitations under the License.
 */
var Machine = function Machine(properties) {
 ...
 * limitations under the License.
 */
var Task = function Task(properties) {
...
/***/ "./src/main/js/services/machineService.js":
/*!************************************************!*\
  !*** ./src/main/js/services/machineService.js ***!
  \************************************************/
/*! no static exports found */
...
var Machine = __webpack_require__(/*! ../model/Machine */ "./src/main/js/model/Machine.js");
  ...
  find: function find() {
    return new Promise(function (resolve, reject) {
      ...
      client({
        ...
        var machineProperties = response.entity;
        var machine = new Machine(machineProperties);
        resolve(machine);
      }, function (response) {
        reject(response);
      });
...
/***/ "./src/main/js/services/taskService.js":
/*!*********************************************!*\
  !*** ./src/main/js/services/taskService.js ***!
  \*********************************************/
/*! no static exports found */
...
var taskService = {
  ...
  findAll: function findAll() {
    return new Promise(function (resolve, reject) {
      ...
      client({
        ...
        /** @type {Array} */
        var taskProperties = response.entity;
        var tasks = taskProperties.map(function (properties) {
  ...
  create: function create(task) {
    return new Promise(function (resolve, reject) {
      ...
      client({
        ...
        var taskProperties = response.entity;
        var task = new Task(taskProperties);
        resolve(task);
      }, function (response) {
        reject(response);
      });
   ...
   * @return {Promise.<Task>}
   */
  deleteByUuid: function deleteByUuid(uuid) {
    return new Promise(function (resolve, reject) {
      var client = rest.wrap(mime).wrap(errorCode);
      client({
        path: '/tasks/' + uuid,
...
/***/ "./src/main/js/utils/uuidUtils.js":
/*!****************************************!*\
  !*** ./src/main/js/utils/uuidUtils.js ***!
  \****************************************/
/*! no static exports found */

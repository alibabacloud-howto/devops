...
* Expand the "Variables" panel, and create the following variables:
  ...
  * TERRAFORM_VERSION = [latest Terraform version](https://github.com/hashicorp/terraform/releases) (e.g. 0.11.11)
...
Congratulation: you have 3 environments! From now on, the process to follow in order to deploy a new version of
